...
contract NativeClassifieds {
    ...
    function openTrade(uint256 _item, uint256 _price)
        ...
        virtual
    {
        require(msg.sender == itemToken.ownerOf(_item), "Only owner can open order!");
        require(itemToken.getApproved(_item) == address(this) || itemToken.isApprovedForAll(msg.sender, address(this)), "Marketplace need authorize from owner!");
        ...
        virtual
    {
        ...
        itemToken.transferFrom(trade.poster, msg.sender, trade.item);
